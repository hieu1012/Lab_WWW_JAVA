package iuh.fit.se.tuan4_demo.controllers;

import iuh.fit.se.tuan4_demo.daos.ProductDAO;
import iuh.fit.se.tuan4_demo.daos.impl.ProductDAOImpl;
...
@WebServlet(name = "productController", urlPatterns = "/producthehe")
